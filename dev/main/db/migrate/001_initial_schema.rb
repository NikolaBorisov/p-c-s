class InitialSchema < ActiveRecord::Migration
  def self.up
    ...
    create_table "article_contents", :primary_key => 'article_content_id', :force => true do |t|
    ...
    create_table "board_types", :primary_key => 'board_type_id', :force => true do |t|
      t.column "name",          :string,  :limit => 256, :default => "", :null => false
    end
    
    create_table "checker_responses", :primary_key => 'checker_response_id', :force => true do |t|
    ...
    create_table "checkers", :primary_key => 'checker_id', :force => true do |t|
      t.column "name",                :string,  :limit => 256, :default => "", :null => false
      t.column "file_id",             :integer,                                :null => false
    ...
    create_table "compiler_options", :primary_key => 'compiler_option_id', :force => true do |t|
    ...
    create_table "compiler_responses", :primary_key => 'compiler_response_id', :force => true do |t|
      t.column "status",               :integer,                                 :null => false
    ...
    create_table "contest_types", :primary_key => 'contest_type_id', :force => true do |t|
      t.column "name",            :string,  :limit => 256, :default => "", :null => false
    end
    ...
    create_table "contests_checkers", :primary_key => 'contest_checker_id', :force => true do |t|
      t.column "contest_id",         :integer, :null => false
    ...
    create_table "contests_modules", :primary_key => 'contest_module_id', :force => true do |t|
      t.column "contest_id",          :integer, :null => false
    ...
    create_table "grader_responses", :primary_key => 'grader_response_id', :force => true do |t|
      t.column "submit_id",                     :integer,                 :null => false
      t.column "module_id",                     :integer,                 :null => true
      t.column "checker_id",                    :integer,                 :null => false
    ...
    create_table "modules", :primary_key => 'module_id', :force => true do |t|
      t.column "name",      :string,  :limit => 256, :default => "", :null => false
      t.column "task_id",   :integer,                                :null => false
    end
    ...
    create_table "modules_files", :primary_key => 'module_file_id', :force => true do |t|
      t.column "module_id",      :integer, :null => false
      t.column "file_id",        :integer, :null => false
    ...
    create_table "program_languages", :primary_key => 'program_language_id', :force => true do |t|
      t.column "name",                :string,  :limit => 256, :default => "", :null => false
    end
    
    create_table "restrictions", :primary_key => 'restriction_id', :force => true do |t|
      t.column "task_id",          :integer, :null => false
    ...
    create_table "sample_solutions", :primary_key => 'sample_solution_id', :force => true do |t|
      t.column "name",               :string,  :limit => 256, :default => "", :null => false
      t.column "file_id",            :integer,                                :null => false
      t.column "task_id",            :integer,                                :null => false
    end
    ...
    create_table "submits", :primary_key => 'submit_id', :force => true do |t|
      t.column "user_id",                      :integer,                  :null => false
      t.column "file_id",                      :integer,                  :null => false
      t.column "task_id",                      :integer,                  :null => false
      t.column "program_language_id",          :integer,                  :null => false
      t.column "submit_at",                    :timestamp
    ...
    create_table "task_contents", :primary_key => 'task_contest_id', :force => true do |t|
      t.column "task_id",         :integer,                 :null => false
    ...
    create_table "test_responses", :primary_key => 'test_response_id', :force => true do |t|
    ...
    create_table "tests_files", :primary_key => 'test_file_id', :force => true do |t|
      t.column "test_id",      :integer, :null => false
      t.column "file_id",      :integer, :null => false
...
#    change_column("users", "school", :string,  :limit=> 128, :default => "", :null => true)
#    change_column("users", "address", :text,  :default => "", :null => true)
#    change_column("users", "telephone", :string,  :limit=> 64, :default => "", :null => true)
  end
  
  def self.down
#    change_column("users", "school", :string,  :limit=> 128, :default => "", :null => false)
#    change_column("users", "address", :text,  :default => "", :null => false)
#    change_column("users", "telephone", :string,  :limit=> 64, :default => "", :null => false)
  end
end
